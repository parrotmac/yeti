...
pub trait OrgFreedesktopModemManager1Bearer {
    fn connect(&self) -> Result<(), tree::MethodErr>;
    fn disconnect(&self) -> Result<(), tree::MethodErr>;
    fn interface(&self) -> Result<String, tree::MethodErr>;
    fn connected(&self) -> Result<bool, tree::MethodErr>;
    fn suspended(&self) -> Result<bool, tree::MethodErr>;
    fn ip4_config(&self) -> Result<arg::PropMap, tree::MethodErr>;
    fn ip6_config(&self) -> Result<arg::PropMap, tree::MethodErr>;
    fn stats(&self) -> Result<arg::PropMap, tree::MethodErr>;
    fn ip_timeout(&self) -> Result<u32, tree::MethodErr>;
    fn bearer_type(&self) -> Result<u32, tree::MethodErr>;
    fn properties(&self) -> Result<arg::PropMap, tree::MethodErr>;
}

pub fn org_freedesktop_modem_manager1_bearer_server<F, T, D>(factory: &tree::Factory<tree::MTFn<D>, D>, data: D::Interface, f: F) -> tree::Interface<tree::MTFn<D>, D>
where
    D: tree::DataType,
    D::Method: Default,
    D::Property: Default,
    T: OrgFreedesktopModemManager1Bearer,
    F: 'static + for <'z> Fn(& 'z tree::MethodInfo<tree::MTFn<D>, D>) -> & 'z T,
{
    let i = factory.interface("org.freedesktop.ModemManager1.Bearer", data);
    let f = ::std::sync::Arc::new(f);
    let fclone = f.clone();
    let h = move |minfo: &tree::MethodInfo<tree::MTFn<D>, D>| {
        let d = fclone(minfo);
    ...
    let p = factory.property::<&str, _>("Interface", Default::default());
    let p = p.access(tree::Access::Read);
    let fclone = f.clone();
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(d.interface()?);
        Ok(())
    });
    let i = i.add_p(p);
    ...
    let p = factory.property::<bool, _>("Suspended", Default::default());
    let p = p.access(tree::Access::Read);
    let fclone = f.clone();
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(d.suspended()?);
        Ok(())
    });
    let i = i.add_p(p);

    let p = factory.property::<arg::PropMap, _>("Ip4Config", Default::default());
    let p = p.access(tree::Access::Read);
    let fclone = f.clone();
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(d.ip4_config()?);
        Ok(())
    });
    let i = i.add_p(p);

    let p = factory.property::<arg::PropMap, _>("Ip6Config", Default::default());
    let p = p.access(tree::Access::Read);
    let fclone = f.clone();
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(d.ip6_config()?);
        Ok(())
    });
    let i = i.add_p(p);

    let p = factory.property::<arg::PropMap, _>("Stats", Default::default());
    let p = p.access(tree::Access::Read);
    let fclone = f.clone();
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
    ...
    let p = factory.property::<u32, _>("IpTimeout", Default::default());
    let p = p.access(tree::Access::Read);
    let fclone = f.clone();
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(d.ip_timeout()?);
        Ok(())
    });
    let i = i.add_p(p);

    let p = factory.property::<u32, _>("BearerType", Default::default());
    let p = p.access(tree::Access::Read);
    let fclone = f.clone();
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(d.bearer_type()?);
        Ok(())
    });
    let i = i.add_p(p);

    let p = factory.property::<arg::PropMap, _>("Properties", Default::default());
    let p = p.access(tree::Access::Read);
    let fclone = f.clone();
    let p = p.on_get(move |a, pinfo| {
        let minfo = pinfo.to_method_info();
        let d = fclone(&minfo);
        a.append(d.properties()?);
        Ok(())
    });
    let i = i.add_p(p);
    i
